...
1. Rendez-vous sur la [plateforme DeepSeek](https://platform.deepseek.com/api_keys)
...
1. ✅ Vérifiez que `.env.local` existe et contient `VITE_DEEPSEEK_API_KEY=votre_clé`
...
2. Le nom de la variable est exactement `VITE_DEEPSEEK_API_KEY` (sensible à la casse)
