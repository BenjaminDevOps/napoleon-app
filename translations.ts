...
export const translations: Record<AppLanguage, any> = {
  en: {
    // Landing
    welcome: "Greetings, my friend. Welcome to The MasterMind. I have spent decades studying the principles used by history's greatest achievers. What is your Definite Chief Aim today?",
    landingTitle: "Master Your Mind",
  ...
  fr: {
    welcome: "Salutations, mon ami. Bienvenue dans The MasterMind. J'ai passé des décennies à étudier les principes des plus grands visionnaires de l'histoire. Quel est votre Objectif Principal défini aujourd'hui ?",
    landingTitle: "Maîtrisez votre Esprit",
    ...
    placeholder: "Demandez au Maître...",
  ...
  es: {
    welcome: "Saludos, amigo mío. Bienvenido a The MasterMind. He pasado décadas estudiando los principios de los más grandes visionarios de la historia. ¿Cuál es su Objetivo Principal hoy?",
    landingTitle: "Domina tu Mente",
    ...
    placeholder: "Pregúntele al Maestro...",
...
export const affirmations = {
  en: [
    { id: 1, text: "I am the master of my fate and the captain of my soul.", author: "The MasterMind" },
    { id: 2, text: "Every adversity carries the seed of an equivalent or greater benefit.", author: "The MasterMind" },
    { id: 3, text: "Whatever I can conceive and believe, I can achieve.", author: "The MasterMind" },
    { id: 4, text: "My thoughts are transmuted into their physical equivalent with burning desire.", author: "The MasterMind" },
    { id: 5, text: "I attract success by being definite in my purpose and persistent in my action.", author: "The MasterMind" },
    { id: 6, text: "I am worthy of abundance, and I receive it gratefully.", author: "The MasterMind" },
    { id: 7, text: "My mind is a powerful magnet, drawing wealth, health and happiness to me now.", author: "The MasterMind" },
    { id: 8, text: "I persist until I succeed. Failure is not an option — only a lesson.", author: "The MasterMind" },
    { id: 9, text: "Today I take one step closer to my definite chief aim.", author: "The MasterMind" },
    { id: 10, text: "I am surrounded by a Master Mind of brilliant, supportive people.", author: "The MasterMind" },
  ],
  fr: [
    { id: 1, text: "Je suis le maître de mon destin et le capitaine de mon âme.", author: "The MasterMind" },
    { id: 2, text: "Chaque adversité porte en elle la graine d'un bénéfice équivalent ou supérieur.", author: "The MasterMind" },
    { id: 3, text: "Tout ce que mon esprit peut concevoir et croire, il peut le réaliser.", author: "The MasterMind" },
    { id: 4, text: "Mes pensées se transmutent en réalité physique grâce à un désir ardent.", author: "The MasterMind" },
    { id: 5, text: "J'attire le succès par la précision de mon but et la persistance de mes actions.", author: "The MasterMind" },
    { id: 6, text: "Je mérite l'abondance et je la reçois avec gratitude.", author: "The MasterMind" },
    { id: 7, text: "Mon esprit est un puissant aimant qui attire la richesse, la santé et le bonheur.", author: "The MasterMind" },
    { id: 8, text: "Je persiste jusqu'à la victoire. L'échec n'est qu'une leçon.", author: "The MasterMind" },
    { id: 9, text: "Aujourd'hui, je fais un pas de plus vers mon objectif principal.", author: "The MasterMind" },
    { id: 10, text: "Je suis entouré d'un Master Mind de personnes brillantes et bienveillantes.", author: "The MasterMind" },
  ],
  es: [
    { id: 1, text: "Soy el amo de mi destino y el capitán de mi alma.", author: "The MasterMind" },
    { id: 2, text: "Cada adversidad lleva la semilla de un beneficio equivalente o mayor.", author: "The MasterMind" },
    { id: 3, text: "Todo lo que mi mente puede concebir y creer, puede lograrlo.", author: "The MasterMind" },
    { id: 4, text: "Mis pensamientos se transmutan en su equivalente físico con deseo ardiente.", author: "The MasterMind" },
    { id: 5, text: "Atraigo el éxito siendo definido en mi propósito y persistente en mi acción.", author: "The MasterMind" },
    { id: 6, text: "Merezco la abundancia y la recibo con gratitud.", author: "The MasterMind" },
    { id: 7, text: "Mi mente es un poderoso imán que atrae riqueza, salud y felicidad.", author: "The MasterMind" },
    { id: 8, text: "Persisto hasta triunfar. El fracaso es solo una lección.", author: "The MasterMind" },
    { id: 9, text: "Hoy doy un paso más hacia mi objetivo principal definitivo.", author: "The MasterMind" },
    { id: 10, text: "Estoy rodeado de un Master Mind de personas brillantes y solidarias.", author: "The MasterMind" },
  ]
};
